...
class VectorizedCoordinates(Scene):
    def construct(self):
        ...
        brace_text = brace.get_text("Predicts a singular y-value")
        ...
        brace_text = brace.get_text("Predicts all y-values at once")
        self.play(GrowFromCenter(brace), Write(brace_text), run_time=2)
        self.wait(2)
        ...
        linear_combo_text = linear_combo_brace.get_text("Linear Combination of x and 1")
